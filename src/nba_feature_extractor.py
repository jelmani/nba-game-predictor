...
class NBAFeatureExtractor:
    ...
    def get_train(self, use_delta_stats: bool = True, train_end: str = "2023-01-01") -> tuple[pd.DataFrame, pd.Series]:
    ...
    def get_test(self, use_delta_stats: bool = True, start: str = "2023-01-01", end: str = "2024-01-01") -> tuple[pd.DataFrame, pd.Series]:
